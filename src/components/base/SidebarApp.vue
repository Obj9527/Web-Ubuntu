<template>
  <div
    class="relative w-auto h-auto m-1 p-2 transition duration-300 hover:bg-white hover:bg-opacity-10 rounded"
  ...
  >
    ...
    <div
      class="w-1 h-1 absolute left-0 top-1/2 bg-ub-orange rounded-sm transform -translate-y-1/2"
      :class="this.isClosed ? 'invisible' : 'visible'"
    ></div>
    <div
